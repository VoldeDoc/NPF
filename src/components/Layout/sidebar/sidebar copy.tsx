...
export const Sidebar = forwardRef<HTMLElement, Props>(
  ({ showNav, setShowNav }, ref) => {
    return (
      <aside
        ref={ref}
        className={`fixed h-full flex flex-col bg-white shadow-sm transition-all duration-1000 md:px-5 ${
          showNav ? "w-[100%] md:w-[18%]" : "md:w-20 w-0"
        }`}
      >
        ...
        <ul className="flex item-center justify-center flex-1 flex-col gap-4 mx-auto flex-grow">
