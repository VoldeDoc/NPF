export const getCardDetails = () => {
    return [
      ...
      },
      {
        ...
        descriptions: ["This covers the devastating", "effect fire can have on assets", "such as building and contents", "n the premises. It cover fires,", "explosions, storms etc…"],
        link: ""
      },
      {
